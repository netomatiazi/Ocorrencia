...
MySQL - 5.5.5-10.1.13-MariaDB : Database - ocorrencia
*********************************************************************
*/
...
insert  into `ocorrencias`(`idocorrencias`,`idsubcategoria`,`idbairro`,`datao`,`logradouro`,`numero`,`latitude`,`longitude`,`anexo`) values (1,3,4,'2018-03-21','Av. Godofredo Schilini','950','-22.380601636605913','-48.395696296264646','anexo/71999354abfe6e850ad0486e7197d18e.jpg');
...
insert  into `usuario`(`idusuario`,`idperfil`,`statusu`,`nome`,`email`,`senha`) values (1,1,1,'Ovidio','ovidio@teste.com','123');
